# Operator Quickstart — Retail Sale of Food in Specialized Stores

Shortest path from clone to a verified local dry-run for **ISIC 4721** (`cloud-itonami-isic-4721`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4721.git
cd cloud-itonami-isic-4721
```
...
- Blueprint governor key: `food-retail-governor`
- Likely source path: `foodretailops.governor.cljc`
